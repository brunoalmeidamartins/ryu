...
if sys.argv[2] == '0': #SemIperf
    arq = open(path_home+'/ryu/Bruno/Resultados/Cenario2/SemIperf/teste'+sys.argv[1]+'.txt', 'w')
elif sys.argv[2] == '1': #Com1Iperf
    arq = open(path_home+'/ryu/Bruno/Resultados/Cenario2/1Iperf/teste'+sys.argv[1]+'.txt', 'w')
else: #Com2Iperf
    arq = open(path_home+'/ryu/Bruno/Resultados/Cenario2/2Iperf/teste'+sys.argv[1]+'.txt', 'w')
